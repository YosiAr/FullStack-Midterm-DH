...
var canvas = document.getElementById("canvas"),
    ...
    loading = true;
    var myh=document.getElementById('cofeemug').offsetHeight ;
	var myw= document.getElementById('cofeemug').offsetWidth +79;
	console.log(myh);
	console.log(myw);
canvas.height =myh ;
canvas.width =myw;
...
smokeImage.src = document.getElementById("smokepic").src;
